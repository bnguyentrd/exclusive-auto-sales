...
2. Open your terminal and enter: git clone -gitlab repository link here-

3. Go into the project directory: CD -project name here-
...
5. Make migrations:
    - docker exec -it -docker container name here- bash
